...
const features = [
  { 
    ...
    description: "We design customized décor setups for weddings, corporate events, and private celebrations." 
  },
  { 
    icon: <FiGift className="w-5 h-5" />, 
    title: "Custom Packages", 
    description: "From floral arrangements to lighting and staging, we tailor packages to match your theme and budget." 
  },
  { 
    icon: <FiUsers className="w-5 h-5" />, 
    title: "Full Event Experience", 
    description: "Enhance your event with mixology services, photography, and videography in partnership with Reborn Pixels." 
  }
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
            Lunax Decor transforms your vision into unforgettable experiences. 
            We specialize in luxury event décor, custom styling, and curated services 
            that elevate weddings, corporate events, and private celebrations.
          </p>
          ...
          <div className="mb-8 grid grid-cols-1 gap-4">
            {features.map((feature, index) => (
              <motion.div 
                ...
                className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-100 dark:border-purple-800 flex items-start"
              >
          ...
          <div className="flex gap-4">
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }} 
              href="https://github.com/rebreborn/rnbluxedecor" 
              target="_blank" 
            ...
            >
              <FiExternalLink className="w-5 h-5" /> Visit Website
            </motion.a>
          </div>
        </motion.div>
        ...
        >
          <div className={`relative rounded-2xl overflow-hidden shadow-xl ${isDark ? 'shadow-purple-900/20' : 'shadow-gray-400/30'}`}>
            ...
            <img
              src={isDark ? '/images/lunax-decor.png' : '/images/lunax-decor.png'}
              alt="Lunax Decor Showcase"
