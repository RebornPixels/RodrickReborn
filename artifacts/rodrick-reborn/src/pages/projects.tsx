...
const projects = [
  ...
  {
    title: "LoopHire",
    description: "LoopHire is a social job referral platform that connects job seekers with professionals willing to refer them.",
  ...
  {
    title: "Lunax Decor",
    description: "An event and wedding decor service offering elegant cocktail party setups, floral arrangements, and personalized design.",
