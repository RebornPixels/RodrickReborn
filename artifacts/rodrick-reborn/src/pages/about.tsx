  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        >
          ...
          <div className="mt-12">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">When I'm not coding, you can find me:</p>
            <ul className="space-y-3 text-gray-700 dark:text-gray-300">
              <li className="flex items-start"><span className="mr-2 text-blue-500">•</span>Capturing landscapes and urban scenes with my DSLR</li>
              <li className="flex items-start"><span className="mr-2 text-blue-500">•</span>Editing video projects and short films</li>
              <li className="flex items-start"><span className="mr-2 text-blue-500">•</span>Experimenting with new photography techniques</li>
              <li className="flex items-start"><span className="mr-2 text-blue-500">•</span>Teaching tech skills to local youth</li>
            </ul>
          </div>
        </motion.div>
      </div>
      ...
      <motion.a
        ...
        className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium rounded-lg shadow-md transition-all duration-300 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900 mt-12"
      >
        <motion.svg
          className="w-5 h-5"
          fill="none"
