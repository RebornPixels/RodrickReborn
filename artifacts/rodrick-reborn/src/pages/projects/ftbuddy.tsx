      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.2, duration: 0.5 }}>
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
            Voice-powered AI fitness assistant with workout tracking, nutrition analysis, AI-generated coaching, and real-time gym support.
          </p>
          ...
          <div className="flex gap-4">
            ...
            <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href="https://ftbuddy.netlify.app/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors">
        ...
        <motion.div initial={{ x: 20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.4, duration: 0.5 }} className="relative">
          <div className={`relative rounded-2xl overflow-hidden shadow-xl ${isDark ? 'shadow-pink-900/20' : 'shadow-gray-400/30'}`}>
            <img src={isDark ? '/images/ftbuddy_dark.png' : '/images/ftbuddy_light.png'} alt="FitBuddy App Screenshot" className="w-full h-auto rounded-2xl border border-gray-200 dark:border-gray-700" />
          </div>
        </motion.div>
      </div>
    </motion.section>
