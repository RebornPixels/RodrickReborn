  ...
  return (
    ...
    >
      <div className="mb-8 rounded-xl overflow-hidden shadow-md">
        <img src="/images/dtunes-cover.jpg" alt="dTunes Preview" className="w-full object-cover" />
      </div>
      ...
      <div className="flex flex-wrap gap-3 mb-8">
        {["Next.js", "Firebase", "Stripe", "Tailwind CSS"].map((tag, i) => (
          <span key={i} className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300 px-3 py-1 text-sm rounded-full">{tag}</span>
        ))}
      </div>
      <div className="flex gap-4 mb-12">
        <a href="https://dtunes.vercel.app" target="_blank" rel="noopener noreferrer" className="px-5 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition">Live Demo</a>
        <a href="https://github.com/RebornPixels/dTunes" target="_blank" rel="noopener noreferrer" className="px-5 py-2 border border-gray-300 dark:border-gray-600 rounded-full text-gray-800 dark:text-gray-200 hover:border-blue-400 transition">GitHub</a>
      </div>
      <div>
