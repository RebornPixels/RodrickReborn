        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 dark:hover:bg-blue-500 text-white font-medium rounded-lg transition-colors disabled:opacity-70"
            >
              {isSubmitting ? 'Sending...' : (<><FiSend className="w-4 h-4" /> Send Message</>)}
            </motion.button>
          </form>
        </motion.div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:rodrickreborn@gmail.com" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <a href="https://x.com/mistakesacademy" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
                      <FiTwitter className="w-4 h-4 mr-1" /> Twitter
                    </a>
                    <a href="https://linkedin.com/in/rodrickramadhani" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
                      <FiLinkedin className="w-4 h-4 mr-1" /> LinkedIn
                    </a>
                    <a href="https://github.com/Rebreborn" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
                      <FiGithub className="w-4 h-4 mr-1" /> GitHub
                    </a>
                  </div>
                </div>
              </div>
